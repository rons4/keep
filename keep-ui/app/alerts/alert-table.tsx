...
import { AlertTerraform } from "./alert-terraform";
...
export function AlertTable({
  ...
  const [terraformDefinition, setTerraformDefinition] = useState<string>("");
  ...
  const openTerraformModal = (alert: Alert): any => {
    setSelectedAlert(alert);
    setIsTerraformOpen(true);
  }

  const closeTerraformModal = (): any => setIsTerraformOpen(false);
    ...
    <>
      ...
      <Table>
        ...
        <AlertsTableBody
          ...
          openModal={openModal}
          openTerraformModal={openTerraformModal}
          workflows={workflows}
          providers={providers}
          mutate={mutate}
      ...
      <AlertTerraform
        ...
        closeModal={closeTerraformModal}
        alert={selectedAlert!}
      />
      <AlertTransition
        isOpen={isOpen}
